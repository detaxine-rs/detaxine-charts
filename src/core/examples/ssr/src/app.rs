...
pub fn App() -> impl IntoView {
    ...
    view! {
        <Stylesheet id="leptos" href="/styles/dashboard.css"/>
        <Title text="detaxine-charts SSR check"/>
        <div id="modal-root"></div>
        <Showcase />
    }
}

/// Full component showcase — exercises every detaxine-charts component for the
